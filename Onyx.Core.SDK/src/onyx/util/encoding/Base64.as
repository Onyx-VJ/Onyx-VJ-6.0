...
*	Optimized by: Daniel Hai / www.danielhai.com
	...
	final public class Base64 {
		...
		public static function encode(data:ByteArray):String {   
			...
			{   
				...
				out.writeInt(c);
				/*
				out.writeByte(encodeChars[c >> 18] );
				out.writeByte(encodeChars[c >> 12 & 0x3f]);
				out.writeByte(encodeChars[c >> 6 & 0x3f]);
				out.writeByte(encodeChars[c & 0x3f]);          
				*/
			}   
